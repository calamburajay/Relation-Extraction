...
class build_data():
    def __init__(self,fname):
        ...
        self.dropout_gru = float(config_file.getProperty("dropout_gru"))
        self.dropout_gru_output = float(config_file.getProperty("dropout_gru_output"))
        ...
        self.hidden_size_gru =int(config_file.getProperty("hidden_size_gru"))
        self.hidden_size_n1 = int(config_file.getProperty("hidden_size_n1"))
        #self.hidden_size_n2 = config_file.getProperty("hidden_size_n2")
        self.num_gru_layers = int(config_file.getProperty("num_gru_layers"))
