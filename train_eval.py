...
if __name__ == "__main__":
    ...
    with tf.compat.v1.Session() as sess:
        ...
        model = tf_utils_v2.model(config,emb_mtx,sess)
        ...
        operations=tf_utils_v2.operations(train_step,obj, m_op, predicted_op_ner, actual_op_ner, predicted_op_rel, actual_op_rel, score_op_rel)
